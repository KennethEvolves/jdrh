...
$this->title = $model->id_servicioSalud;
...
<div class="servicio-salud-view">
    ...
    <p>
        <?= Html::a('Actualizar', ['update', 'id_servicioSalud' => $model->id_servicioSalud], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Eliminar', ['delete', 'id_servicioSalud' => $model->id_servicioSalud], [
