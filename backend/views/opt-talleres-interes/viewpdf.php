...
$this->title = $model->nombre_taller;
...
?>
<div class="opt-talleres-interes-view" style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px;">
    ...
    <h3 style="text-align: center; font-weight: normal; color: #7f8c8d;">Reporte de Taller de Interés</h3>
    
    <!-- Título del taller -->
    <h1 style="text-align: center; font-size: 24px; margin-top: 30px;"><?= Html::encode($model->nombre_taller) ?></h1>

    <!-- Detalle del taller con formato -->
    <div style="margin-top: 30px;">
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                // Agregar más atributos del modelo si es necesario
            ],
            'options' => [
