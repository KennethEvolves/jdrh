...
class ExpedienteController extends Controller
{
     ...
     * @param int $idexpediente Idexpediente
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($idexpediente)
    {
        return $this->render('view', [
            'model' => $this->findModel($idexpediente),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'idexpediente' => $model->idexpediente]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($idexpediente)
    {
        $model = $this->findModel($idexpediente);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($idexpediente)
    {
        $this->findModel($idexpediente)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($idexpediente)
    {
        if (($model = Expediente::findOne(['idexpediente' => $idexpediente])) !== null) {
            return $model;
        }
