 ...
 * @property int|null $creditos_asignatura
...
class UnidadEstudio extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['creditos_asignatura', 'num_momentos', 'plan_estudios_id_plan', 'fases_id_fase'], 'integer'],
            [['des_general', 'ras_perfil', 'sabe_profesionales', 'elem_universo'], 'string'],
            [['clave', 'semestre'], 'string', 'max' => 45],
            [['nombre_asignatura'], 'string', 'max' => 50],
            [['satca'], 'string', 'max' => 15],
